...
class NewsEyesControl: UIControl{
    ...
    private var eyesView = UIView(frame: CGRect(origin: .zero, size: CGSize(width: 30.0, height: 30.0)))
    private var eyesButtom = UIButton(type: .custom)
    private lazy var eyesLabel: UILabel = {
        let label = UILabel()
